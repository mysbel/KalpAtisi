...
<body>
     ...
     <div class="container-fluid nav-bar">
        <div class="container">
            ...
            <div class="card">
                <img src="/public/image/scanner.jpg" alt="Image" class="round-image">
                <textarea id="userInput" name="resultat" placeholder="Veuillez entrez le type de scanner" required></textarea>
                <br>
