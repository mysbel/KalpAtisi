...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body {
            background-image: url('/public/image/notifMed.jpg'); /* Remplacez URL_DE_VOTRE_IMAGE par le lien de votre image */
...
<body>
    ...
    <script>
        ...
        function fetchNotifications() {
            fetch('fetch_notifications_infirmier.php') //script PHP pour récupérer les notifications
